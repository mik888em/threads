...
- Джобу ограничивает внешний таймаут в 100 минут, а сам сервис завершится раньше (по умолчанию через 35 минут ожидания), если зависнет или получит сигнал остановки.
